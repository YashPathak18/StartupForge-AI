...
export default function LoginPage() {
  ...
  const handleDemoLogin = () => {
    setEmail("founder@startupforge.ai");
    setPassword("secureStartup123!");
  };
    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full glass-panel p-8 rounded-2xl border border-zinc-800 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-zinc-400 mt-1">Access your startup blueprints & strategic roadmaps</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? "Authenticating..." : "Sign In to Forge"}
